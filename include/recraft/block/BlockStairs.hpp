...
public:
    ...
    static Half halfFromMeta(Metadata meta) { return (meta & 0x4) ? Half::Top : Half::Bottom; }

    TextureSet getTextures(Metadata meta) const override { return m_modelBlock->getTextures(m_modelMeta); }

    BlockID getDropID(Metadata meta) const override { return m_modelBlock->getDropID(m_modelMeta); }

    Metadata getDropMeta(Metadata meta) const override { return m_modelMeta; }
