...
public:
    ...
    TextureSet getTextures(Metadata meta) const override { return TextureSet(textureFromMeta(m_texturePrefix, meta)); }

    Metadata getDropMeta(Metadata meta) const override { return meta & 0xF; }
