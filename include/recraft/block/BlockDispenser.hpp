...
public:
    ...
    static bool isTriggered(Metadata meta) { return (meta >> 3) & 0x1; }
    ...
    TextureSet getTextures(Metadata meta) const override {
        ...
        switch (facing) {
        case Facing::Down:
            ts.faces[Direction::Bottom] = "dispenser_front_vertical";
            break;
        case Facing::Up:
            ts.faces[Direction::Top] = "dispenser_front_vertical";
            break;
        case Facing::North:
            ts.faces[Direction::North] = "dispenser_front";
            break;
        case Facing::South:
            ts.faces[Direction::South] = "dispenser_front";
            break;
        case Facing::West:
            ts.faces[Direction::West] = "dispenser_front";
            break;
        case Facing::East:
            ts.faces[Direction::East] = "dispenser_front";
            break;
        }
    ...
    BlockID getDropID(Metadata meta) const override { return BlockID::Dispenser; }
