...
public:
    ...
    TextureSet getTextures(Metadata meta) const override {
        ...
        if (isSeamless(meta)) {
            ...
            case Variant::Sand:        top = "sandstone_top";    break;
            case Variant::Quartz:      top = "quartz_block_top"; break;
            case Variant::Stone:
            default:                   top = "stone_slab_top";   break;
            }
    ...
    BlockID getDropID(Metadata meta) const override {
        return BlockID::Double_Stone_Slab;
    }
};