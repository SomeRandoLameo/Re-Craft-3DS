...
public:
    ...
    static Facing facingFromMeta(Metadata meta) {
        return static_cast<Facing>(meta & 0x3);
    }

    static Part partFromMeta(Metadata meta) {
        return (meta & 0x8) ? Part::Head : Part::Foot;
    }

    static bool isOccupied(Metadata meta) {
        return (meta & 0x4) && partFromMeta(meta) == Part::Head;
    }
