...
public:
    ...
    static bool isExtended(Metadata meta) {
        return (meta >> 3) & 0x1;
    }
    ...
    TextureSet getTextures(Metadata meta) const override {
        ...
        const char* front = extended
            ? "piston_top_sticky" // extended sticky shows different face
        ...
        switch (facing) {
        case Facing::Down:  ts.faces[Direction::Bottom] = front; break;
        case Facing::Up:    ts.faces[Direction::Top]    = front; break;
        case Facing::North: ts.faces[Direction::North]  = front; break;
        case Facing::South: ts.faces[Direction::South]  = front; break;
        case Facing::West:  ts.faces[Direction::West]   = front; break;
        case Facing::East:  ts.faces[Direction::East]   = front; break;
        }
    ...
    BlockID getDropID(Metadata meta) const override {
        return m_isSticky ? BlockID::Sticky_Piston : BlockID::Piston;
    }
