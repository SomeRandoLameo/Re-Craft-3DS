...
public:
    ...
    mc::Vector3f position = mc::Vector3f(0.f, 0.f, 0.f);
    mc::Vector3f velocity = mc::Vector3f(0.f, 0.f, 0.f);

    mc::Vector3f forwardVec = mc::Vector3f(0.f, 0.f, 0.f);
    mc::Vector3f rightVec   = mc::Vector3f(0.f, 0.f, 0.f);
    mc::Vector3f movement   = mc::Vector3f(0.f, 0.f, 0.f);
    ...
    mc::Vector3f spawnPos = mc::Vector3f(0, 0, 0);
