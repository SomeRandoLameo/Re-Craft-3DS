...
namespace terra {
    ...
    public:
        ...
        T_Chunk(const T_Chunk& other) = delete;
        T_Chunk& operator=(const T_Chunk& other) = delete;

        T_Chunk(const mc::world::Chunk& other);
    ...
    typedef std::shared_ptr<T_Chunk> ChunkPtr;
