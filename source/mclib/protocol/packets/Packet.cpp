        ...
        namespace packets {
            ...
            namespace out {
                ...
                DataBuffer ClientStatusPacket::Serialize() const {
                    VarInt action(static_cast<s32>(m_Action));
                    DataBuffer buffer;
                ...
                DataBuffer ClientSettingsPacket::Serialize() const {
                    ...
                    DataBuffer buffer;
                    VarInt chatMode(static_cast<s32>((int)m_ChatMode));
                    VarInt hand(static_cast<s32>((int)m_MainHand));
                ...
                DataBuffer UseEntityPacket::Serialize() const {
                    ...
                    VarInt type(static_cast<s32>((int)m_Action));
                    ...
                    if (m_Action == Action::Interact || m_Action == Action::InteractAt) {
                        VarInt hand(static_cast<s32>((int)m_Hand));
                        buffer << hand;
                    }
                ...
                DataBuffer ResourcePackStatusPacket::Serialize() const {
                    DataBuffer buffer;
                    VarInt result(static_cast<s32>((int)m_Result));
                ...
                DataBuffer PlayerBlockPlacementPacket::Serialize() const {
                    DataBuffer buffer;
                    Position location((s32)m_Position.x, (s32)m_Position.y, (s32)m_Position.z);
                    VarInt face(static_cast<s32>(m_Face)), hand(static_cast<s32>(m_Hand));
