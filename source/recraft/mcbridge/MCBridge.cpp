...
bool MCBridge::connect() {
    ...
    try {
        ...
        m_client->GetConnection()->GetSettings().SetMainHand(mc::MainHand::Right).SetViewDistance(static_cast<s32>(1));
...
void MCBridge::startBackgroundThread() {
    ...
    m_thread = threadCreate(threadFunc, this, THREAD_STACK_SIZE, THREAD_PRIORITY, THREAD_CORE, false);
...
BlockID MCBridge::MCLibBlockToCTBlock(u32 BlockType) {
    ...
    if (BlockType == 0)
        ...
        return BlockID::Planks;
    else if (BlockType == 82)
        return BlockID::Planks;
    else if (BlockType == 83)
        return BlockID::Planks;
        ...
        return BlockID::Planks;
    // 96 - 101 = sapling
    else if (BlockType == 112)
        return BlockID::Bedrock;
    else if (BlockType == 128)
        return BlockID::Water; // Flowing water, actually
    else if (BlockType == 144)
        return BlockID::Water;
    else if (BlockType == 160)
        return BlockID::Lava; // Flowing lava, actually
    else if (BlockType == 176)
        return BlockID::Lava;
    else if (BlockType == 192)
        return BlockID::Sand;
    else if (BlockType == 193)
        return BlockID::Sand;
    else if (BlockType == 298)
        return BlockID::Gravel;
    else if (BlockType == 224)
        return BlockID::Gold_Ore;
    else if (BlockType == 240)
        return BlockID::Iron_Ore;
    else if (BlockType == 256)
        return BlockID::Coal_Ore;
    else if (BlockType == 272)
        return BlockID::Log;
    else if (BlockType == 273)
        return BlockID::Log;
    else if (BlockType == 274)
        return BlockID::Log;
    else if (BlockType == 275)
        return BlockID::Log;
    else if (BlockType == 288)
        return BlockID::Leaves;
    else if (BlockType == 289)
        return BlockID::Leaves;
    else if (BlockType == 290)
        return BlockID::Leaves;
    else if (BlockType == 291)
        return BlockID::Leaves;
    // 304 - 305 = sponge
    else if (BlockType == 320)
        return BlockID::Glass;
    // 336 = lapis ore
    // 352 = lapis block
    // 368 = dispenser
    else if (BlockType == 384)
        return BlockID::Sandstone;
    else if (BlockType == 385)
        return BlockID::Sandstone;
    else if (BlockType == 386)
        return BlockID::Sandstone;
    // 400 = note block
    // 416 = bed
    // 432 = powered rail
    ...
    // 528 = piston
    // 544 = piston head
    else if (BlockType == 560)
        return BlockID::Wool;
    else if (BlockType == 561)
        return BlockID::Wool;
    else if (BlockType == 562)
        return BlockID::Wool;
    else if (BlockType == 563)
        return BlockID::Wool;
    else if (BlockType == 564)
        return BlockID::Wool;
    else if (BlockType == 565)
        return BlockID::Wool;
    else if (BlockType == 566)
        return BlockID::Wool;
    else if (BlockType == 567)
        return BlockID::Wool;
    else if (BlockType == 568)
        return BlockID::Wool;
    else if (BlockType == 569)
        return BlockID::Wool;
    else if (BlockType == 570)
        return BlockID::Wool;
    else if (BlockType == 571)
        return BlockID::Wool;
    else if (BlockType == 572)
        return BlockID::Wool;
    else if (BlockType == 573)
        return BlockID::Wool;
    else if (BlockType == 574)
        return BlockID::Wool;
    else if (BlockType == 575)
        return BlockID::Wool;
    ...
    else if (BlockType == 656)
        return BlockID::Gold_Block;
    else if (BlockType == 672)
    ...
    else if (BlockType == 896)
        return BlockID::Diamond_Ore;
    else if (BlockType == 912)
        return BlockID::Diamond_Block;
    else if (BlockType == 928)
    ...
    // registry->RegisterBlock(new Block("minecraft:wooden_door", 1024, true)); This one is commented out because upper
    // and lower door parts are separate registry->RegisterBlock(new Block("minecraft:ladder", 1040, true));
    ...
    // registry->RegisterBlock(new Block("minecraft:iron_door", 1136, true)); This one is commented out because upper
    // and lower door parts are separate registry->RegisterBlock(new Block("minecraft:wooden_pressure_plate", 1152,
    // true)); registry->RegisterBlock(new Block("minecraft:redstone_ore", 1168, true)); registry->RegisterBlock(new
    // Block("minecraft:lit_redstone_ore", 1184, true)); registry->RegisterBlock(new
    // Block("minecraft:unlit_redstone_torch", 1200, true)); registry->RegisterBlock(new
    // Block("minecraft:redstone_torch", 1216, true)); registry->RegisterBlock(new Block("minecraft:stone_button", 1232,
    // true)); registry->RegisterBlock(new Block("minecraft:snow_layer", 1248, true)); registry->RegisterBlock(new
    // Block("minecraft:ice", 1264, true)); registry->RegisterBlock(new Block("minecraft:snow", 1280, true));
    ...
    else if (BlockType == 1568)
        return BlockID::Stonebrick;
    else if (BlockType == 1569)
        return BlockID::Stonebrick;
    else if (BlockType == 1570)
        return BlockID::Stonebrick;
    else if (BlockType == 1571)
        return BlockID::Stonebrick;
    ...
    // registry->RegisterBlock(new Block("minecraft:leaves2", 2576, true)); wth are leaves2, are they leaves but
    // better??? registry->RegisterBlock(new Block("minecraft:leaves2", 2577, true)); registry->RegisterBlock(new
    // Block("minecraft:log2", 2592, true)); wth is log2, are they logs but better??? registry->RegisterBlock(new
    // Block("minecraft:log2", 2593, true)); registry->RegisterBlock(new Block("minecraft:acacia_stairs", 2608, true));
...
ItemStack MCBridge::MCLIBSlotToCTItemStack(mc::inventory::Slot in) {
    return (ItemStack){static_cast<BlockID>(in.GetItemId()), (u8)in.GetItemDamage(), in.GetItemCount()};
}
