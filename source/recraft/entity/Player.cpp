...
void Player::InitializeInventory() {
    ...
    // inventory[slotIndex++] = mc::inventory::Slot(static_cast<s32>(BlockID::Smooth_Stone), 1, 0); (doesnt exist
    // in 1.12 for some reason)
    ...
    // inventory[slotIndex++] = mc::inventory::Slot(static_cast<s32>(BlockID::Lava), 1, 0); Not accessible, bevause the
    // texture is atlass based, not face based inventory[slotIndex++] =
    // mc::inventory::Slot(static_cast<s32>(BlockID::Water), 1, 0); same reason here
