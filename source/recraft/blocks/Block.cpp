...
Texture_Map BlockRegistry::m_textureMap;

BlockRegistry::BlockRegistry() {

    Texture_MapInit(&m_textureMap, blockTextures, sizeof(blockTextures) / sizeof(blockTextures[0]));

    for (size_t i = 0; i < sizeof(blockTextures) / sizeof(blockTextures[0]); i++) {
        auto icon = Texture_MapGetIcon(&m_textureMap, blockTextures[i]);
        icons[i].u = icon.u;
        icons[i].v = icon.v;
    }
    ...
    RegisterBlock((new GrassBlock(BlockID::Grass, "grass"))
                      ->setTopBottomSidesTexture(icons[4].u, icons[4].v, // top (grass_top)
    ...
    RegisterBlock((new Block(BlockID::Log, "log"))
                      ->setTopBottomSidesTexture(icons[8].u, icons[8].v, // top (oaklog_top)
    ...
    RegisterBlock((new Block(BlockID::Snow_Grass, "snow_grass"))
                      ->setTopBottomSidesTexture(icons[20].u, icons[20].v, // top
    ...
    RegisterBlock((new Block(BlockID::Obsidian, "obsidian"))
                      ->setAllSidesTexture(icons[21].u, icons[21].v)
                      //->setSoundType(SoundType::STONE)
                      ->setDestroyTime(0.5f));

    RegisterBlock((new Block(BlockID::Sandstone, "sandstone"))
                      ->setTopBottomSidesTexture(icons[23].u, icons[23].v, // top
                                                 icons[24].u, icons[24].v, // bottom
                                                 icons[22].u, icons[22].v // sides
                                                 )
                      ->setSoundType(SoundType::STONE)
                      ->setDestroyTime(0.8f));
    ...
    RegisterBlock(
        (new Block(BlockID::Grass_Path, "grass_path"))
            ->setTopBottomSidesTexture(icons[30].u, icons[30].v, icons[1].u, icons[1].v, icons[29].u, icons[29].v)
            //->setSoundType(SoundType::GRASS)
            ->setDestroyTime(0.6f));

    RegisterBlock(
        (new Block(BlockID::Crafting_Table, "crafting_table"))
            ->setTopBottomSidesTexture(icons[32].u, icons[32].v, icons[12].u, icons[12].v, icons[31].u, icons[31].v)
            ->setSoundType(SoundType::STONE)
            ->setDestroyTime(0.8f));
    ...
    RegisterBlock(
        (new Block(BlockID::Furnace, "furnace"))
            ->setTopBottomSidesTexture(icons[45].u, icons[45].v, icons[44].u, icons[44].v, icons[43].u, icons[43].v)
            ->setSoundType(SoundType::STONE)
            ->setDestroyTime(0.8f));
...
BlockRegistry::~BlockRegistry() {
    C3D_TexDelete(&m_textureMap.texture);
}